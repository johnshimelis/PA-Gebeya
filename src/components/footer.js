  ...
  return (
    <section>
      <div className="footer">
        <div className="footer-box-intro">
          <div className="box-1">
            <h2 className="heading">Superior online shopping in the UAE</h2>
            <p className="short">
              ...
              best experience for our customers. We deliver to Dubai, Abu Dhabi, and all other cities in the UAE. As
              a superstore with multiple departments and exceptional customer service, we offer so much more than
              your average online shop. We go above and beyond to make your shopping experience as stress-free as
              possible, with products that offer <u>long-term</u> quality. Save time and effort, and enjoy one-stop
              shopping from the comfort of your home. Shop online and get free shipping on orders over a set amount.
            </p>
          </div>
          <div className="box-1">
            <h2 className="heading">Shop the best products &amp; brands at noon UAE</h2>
            <p className="short">
              You’ll find a massive variety of products from <u>top brands</u> at <u>noon UAE</u>. Our electronics
              department has the{" "}
              <a
              ...
              <a
                href="https://www.noon.com/uae-en/electronics-and-mobiles/portable-audio-and-video/headphones-24056/"
                target="_blank"
              >
                headphones
              </a>{" "}
              ...
              fashion brands. Our accessories range includes watches, eyewear, handbags, and other style essentials.
              You will find plenty of clothing, accessories and shoes for boys and girls of all ages in our{" "}
              <u>UAE kids’ clothing store</u>.{" "}
              ...
              other things to keep your child busy. Our baby product selection features everything from diapers to
              baby transport, nursing and feeding products,{" "}
              <a href="https://www.noon.com/uae-en/toys-and-games/baby-and-toddler-toys/" target="_blank">
                baby toys
              </a>
              ...
              products to help you reach your goals. <br /> At noon, you’ll find everything you need for your home,
              kitchen, tech and fashion needs, with a broad range of high-quality products at competitive prices.
              With flexible payment plans, speedy delivery, and an exceptional shopping experience, noon is your
      ...
      <div className="footer-rights">
        <ul>
          <li>
            <a href="#">©️ 2023 noon. All rights Reserved</a>
          </li>
          {[
